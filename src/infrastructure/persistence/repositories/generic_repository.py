...
class GenericRepository(Generic[TEntity], ABCGenericRepository[TEntity]):
    def __init__(self, db: DbClient, collection: str) -> None:
        try:
            ...
            raise ApplicationException(Exceptions.InternalServerException, "Error initializing repository.", [str(e)])
    ...
    def get_all(self, **filters: Any) -> list[TEntity]:
        try:
            ...
            raise ApplicationException(Exceptions.InternalServerException, "Error retrieving entities.", [str(e)])
    ...
    def get(self, **filters: Any) -> TEntity | None:
        try:
            ...
            raise ApplicationException(Exceptions.InternalServerException, "Error retrieving entity.", [str(e)])
    ...
    def create(self, entity: TEntity) -> TEntity:
        try:
            ...
            raise ApplicationException(Exceptions.InternalServerException, "Error creating entity.", [str(e)])
    ...
    def update(self, id: UUID, entity: TEntity) -> bool:
        try:
            ...
            LOG.error(f"Error updating {self._collection} entity with id {id}: {e}")
            raise ApplicationException(Exceptions.InternalServerException, "Error updating entity.", [str(e)])
    ...
    def delete(self, id: UUID) -> bool:
        try:
            ...
            LOG.error(f"Error deleting {self._collection} entity with id {id}: {e}")
            raise ApplicationException(Exceptions.InternalServerException, "Error deleting entity.", [str(e)])
